...
export function writeRuntimeSettings(patch: Partial<RuntimeSettings>): RuntimeSettings {
  const current = readRuntimeSettings();
  const next: RuntimeSettings = {
    ...current,
    ...patch,
    ollamaConfig: patch.ollamaConfig !== undefined ? patch.ollamaConfig : current.ollamaConfig,
  };
